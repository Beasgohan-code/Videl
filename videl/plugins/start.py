...
# Videl Start & Settings Plugin

import asyncio
from pyrogram import enums, filters, types
from videl import app, config, db, lang
from videl.helpers._inline import buttons
from videl.helpers._utilities import send_log
...
async def start(_, message: types.Message):
    if message.from_user and message.from_user.id in app.bl_users and message.from_user.id not in db.notified:
        return await message.reply_text(message.lang["bl_user_notify"].format(config.SUPPORT_CHAT))
